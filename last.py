...
if __name__ == '__main__':
    ...
    for runid in range(1):
        ...
        for uid in uid_list:
            ...
            test_pred = inverse_transform(LAST(x_test[uid]), min_phi, max_phi)
            test_pred_theta = inverse_transform(LAST(x_test_theta[uid]), min_theta, max_theta)
            ...
            df_test_result.to_csv('result/last_result_uid_{}.csv'.format(uid), index=None)
...
df.to_csv("result/last_rmse.csv", index=None)
